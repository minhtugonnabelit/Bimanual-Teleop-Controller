...
target = joined.A @ sm.SE3(0.2, 0.2, 0.1).A @ sm.SE3.RPY(0.3,0.1,0.1).A
target1 = joined.A @ sm.SE3(0.0, 0.2, 0.1).A @ sm.SE3.RPY(0.3,0.1,0.1).A
target2 = joined.A @ sm.SE3(0.2, 0.0, 0.1).A @ sm.SE3.RPY(0.3,0.1,0.1).A
...
for target in traj:
    ...
    while not arrived:
        ...
        # convert twist extracted from local frame to the global frame
        # middle_twist = adjoint_transform(joined.A) @ middle_twist  # Transform the twist to the global frame
